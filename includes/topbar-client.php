<header
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="hidden sm:flex items-center bg-[#14121f] border border-gray-800 rounded-lg px-3 py-2 w-56 md:w-80">
            ...
            <input type="text" placeholder="Search creators, contracts..."
        ...
        <div class="relative" id="profile-menu-root">
            <button id="profile-menu-button"
                ...
                <img src="https://i.pinimg.com/564x/b3/e5/db/b3e5db5a3bf1399f74500a6209462794.jpg"
                    alt="avatar" class="w-8 h-8 rounded-full object-cover border-2 border-[#3b1054]">
                <div class="hidden sm:block text-left">
                    <div class="text-sm font-medium text-white"><?= escape_output(get_user_name()) ?></div>
            ...
            <div id="profile-menu"
                ...
                <a href="<?= url('/client/profile.php') ?>"
                    class="block px-4 py-2 text-sm text-gray-300 hover:bg-[#14121f] hover:text-white">Profile</a>
                <a href="<?= url('/client/settings.php') ?>"
                    class="block px-4 py-2 text-sm text-gray-300 hover:bg-[#14121f] hover:text-white">Settings</a>
