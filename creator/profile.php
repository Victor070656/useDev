...
<div class="min-h-screen flex bg-[#0f0e16] text-gray-100">
    <?php
    // include your existing sidebar (it should output sidebar HTML)
    ...
    <div class="flex-1 flex flex-col transition-all duration-300 md:ml-64">
        ...
        <div class="px-12 py-6">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2">Update your professional information to attract more clients</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="flex items-center space-x-6">
                    <div
                        class="w-24 h-24 rounded-full bg-gradient-to-r from-purple-600 to-purple-800 flex items-center justify-center text-white text-2xl font-bold overflow-hidden">
                        <?php if ($user['profile_picture']): ?>
                            <img src="<?= escape_output($user['profile_picture']) ?>" alt="Profile"
                    ...
                    <form method="POST" action="upload-profile-picture.php" enctype="multipart/form-data"
                        class="flex-1">
                        <?= csrf_field() ?>
                        <div class="flex items-center space-x-3">
                            <input type="file" name="profile_picture" accept="image/jpeg,image/jpg,image/png,image/webp"
                                required
                            ...
                            <button type="submit"
                                class="px-6 py-2 bg-purple-600 text-white rounded-full font-semibold hover:bg-purple-700 transition">
                                Upload
                            </button>
                        </div>
            ...
            <form method="POST" class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div class="space-y-6">
                    <!-- Headline -->
                    <div>
                        <label for="headline" class="block text-sm font-semibold text-gray-700 mb-2">Professional
                            Headline</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="hourly_rate" class="block text-sm font-semibold text-gray-700 mb-2">Hourly Rate
                                (USD)</label>
                            <input type="number" id="hourly_rate" name="hourly_rate" min="0" step="5"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                placeholder="50" value="<?= escape_output($profile['hourly_rate'] ?? '') ?>">
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="website_url"
                                class="block text-sm font-semibold text-gray-700 mb-2">Website/Portfolio URL</label>
                        ...
                        <div>
                            <label for="github_url" class="block text-sm font-semibold text-gray-700 mb-2">GitHub
                                URL</label>
                        ...
                        <div>
                            <label for="linkedin_url" class="block text-sm font-semibold text-gray-700 mb-2">LinkedIn
                                URL</label>
                    ...
                    <div class="flex justify-between items-center pt-6">
                        <a href="<?= url('/creator/') ?>" class="text-gray-600 hover:text-gray-900">← Back to
                            Dashboard</a>
                        <button type="submit"
