...
<div class="min-h-screen flex bg-[#0f0e16] text-gray-100">
    ...
    <div class="flex-1 flex flex-col transition-all duration-300 md:ml-64">
        ...
        <div class="px-12 py-6">
            ...
            <h1 class="text-3xl font-bold mb-8">My Contracts</h1>
            ...
            <div class="space-y-6">
                <?php if (empty($contracts)): ?>
                    <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                        ...
                        <a href="briefs.php"
                            class="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-full font-semibold hover:opacity-90 transition inline-block">
                            Browse Projects
                        </a>
                    </div>
                <?php else: ?>
                    <?php foreach ($contracts as $contract): ?>
                        <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h3 class="text-xl font-bold text-gray-900 mb-2"><?= escape_output($contract['brief_title']) ?>
                                    </h3>
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="w-10 h-10 rounded-full bg-gradient-to-r from-purple-600 to-purple-800 flex items-center justify-center text-white font-bold">
                            ...
                            <div class="flex items-center space-x-3">
                                <a href="../messages/thread.php?user_id=<?= $contract['client_id'] ?>"
                                    class="px-6 py-2 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-full font-semibold hover:opacity-90 transition">
                                    Message Client
                                </a>
    
                                <?php if ($contract['status'] === 'active'): ?>
                                    <a href="../client/brief-detail.php?id=<?= $contract['brief_id'] ?>"
                                        class="px-6 py-2 border border-gray-300 text-gray-700 rounded-full font-semibold hover:bg-gray-50 transition">
                                        View Project Brief
                                    </a>
                                <?php endif; ?>
